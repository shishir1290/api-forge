...
> = {
  ...
  admin: {
    ...
    icon: <Shield size={11} />,
    color: "#bc8cff",
    desc: "Manage members & collections",
  },
  editor: {
    label: "Editor",
    icon: <Edit3 size={11} />,
    color: "#58a6ff",
    desc: "Edit requests & collections",
  },
  viewer: {
    label: "Viewer",
    icon: <Eye size={11} />,
...
function RoleDropdown({
  ...
  if (isTargetOwner || !canEdit) return <RoleBadge role={current} />;
    ...
    <div style={{ position: "relative" }}>
      <button
        ...
        style={{
          ...
          fontSize: 10,
          fontWeight: 600,
          color: ROLE_CONFIG[current].color,
          fontFamily: "Inter, sans-serif",
        }}
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 11, color: "var(--text-muted)" }}>
              They will be added as {ROLE_CONFIG[role].label}
            </div>
          </div>
          <button
            onClick={onClose}
              ...
              >
                {(ROLES.filter((r) => r !== "owner") as TeamRole[]).map((r) => (
                  ...
                  >
                    ...
                    >
                      <span style={{ color: ROLE_CONFIG[r].color }}>
                        {ROLE_CONFIG[r].icon}
                      </span>
                      <span
                        style={{
...
export default function TeamPanel() {
  ...
  const pendingCount = workspace.members.filter(
    (m) => m.status === "pending",
  ).length;
                  ...
                  {useAppStore.getState().workspaces.map((w) => (
                    <button
                      ...
                      style={{
                        ...
                        width: "100%",
                        background:
                          workspace.id === w.id ? "var(--bg-active)" : "none",
                        border: "none",
                        cursor: "pointer",
                        padding: "8px 10px",
                        borderRadius: 6,
      ...
      <div style={{ flex: 1, overflow: "auto" }}>
        ...
        {filtered.map((member) => (
          ...
          >
            ...
            />
            {member.role !== "owner" && isWorkspaceOwner && (
              <button
                onClick={() => {
                  if (
                    window.confirm(`Remove ${member.name} from the workspace?`)
                  )
